...
var MainView = function (_AbstractApplication) {
    ...
    _createClass(MainView, [{
        ...
        value: function resize() {
            _get(MainView.prototype.__proto__ || Object.getPrototypeOf(MainView.prototype), 'renderer', this).domElement.width = this.renderer.domElement.clientWidth;
            _get(MainView.prototype.__proto__ || Object.getPrototypeOf(MainView.prototype), 'renderer', this).domElement.height = this.renderer.domElement.clientHeight;
            _get(MainView.prototype.__proto__ || Object.getPrototypeOf(MainView.prototype), 'renderer', this).setViewport(0, 0, this.renderer.domElement.clientWidth, this.renderer.domElement.clientHeight);

            _get(MainView.prototype.__proto__ || Object.getPrototypeOf(MainView.prototype), 'camera', this).aspect = this.container.clientWidth / this.container.clientHeight;
            _get(MainView.prototype.__proto__ || Object.getPrototypeOf(MainView.prototype), 'camera', this).updateProjectionMatrix();
